    ...
    <Box mt="80px">
      ...
      >
        ...
        >
          ...
          <Button padding={["10px", "20px", "30px"]} w="50%">
            <Text fontSize={["16px", "20px", "20px"]}>Các vị trí hiện tại</Text>
          </Button>
        </Flex>
      </Box>
      ...
      <Box backgroundColor="rgba(234, 242, 254, 0.5)">
        <Box maxW="1200px" margin="auto" pt="50px" pb="50px">
          <Text textAlign="center" fontSize="30px" fontWeight="700" mb="50px">
        ...
        >
          ...
          >
            <Flex direction="column">
              <Text mb="15px" fontSize="20px" fontWeight="700">
                Content Marketing
              </Text>
